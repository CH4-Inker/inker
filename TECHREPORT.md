...
*   **Final Prototype Assembly**: We completed the final prototype, housing the electronic components in the manually crafted infraboard enclosure:

| 📱 Final Product (Front View) | 🔌 Inside Components & Wiring |
| :---: | :---: |
| ![Final product front view](docs/Final%20product%20front%20view.jpeg) | ![Inside of final product](docs/Inside.jpeg) |
| *Figure 14: Completed physical final product front view.* | *Figure 15: Inside layout showing the perfboard, battery, and connections.* |

*   **OLED Face Animations**: Each media action is mirrored on the OLED face with a matching pixel-art animation (designed in Aseprite, running live on the physical hardware), giving the device an expressive, eye-catching character on top of the eyes-free haptic controls:
...
| *Figure 16: Face animation triggered on Play.* | *Figure 17: Face animation triggered on Pause.* | *Figure 18: Idle/looping animation while music is actively playing.* |
...
| *Figure 19: Face animation triggered on the Previous track control.* | *Figure 20: Face animation triggered on the Next track control.* |
